...
class Cifar10Net(nn.Module):
    def __init__(self, T=8, base_width=256, num_classes=10):
        ...
        self.conv1 = ConvBlock(conv3x3(base_width, base_width), TemporalBatchNorm(base_width, T),
                               create_mslif(), sparse_weights=True, sparse_neurons=True)
        self.conv2 = ConvBlock(conv3x3(base_width, base_width), TemporalBatchNorm(base_width, T),
                               create_mslif(), sparse_weights=True, sparse_neurons=True)
        self.maxpool2 = nn.MaxPool2d(2, 2)
        self.conv3 = ConvBlock(conv3x3(base_width, base_width), TemporalBatchNorm(base_width, T),
                               create_mslif(), sparse_weights=True, sparse_neurons=True)
        self.conv4 = ConvBlock(conv3x3(base_width, base_width), TemporalBatchNorm(base_width, T),
                               create_mslif(), sparse_weights=True, sparse_neurons=True)
        self.conv5 = ConvBlock(conv3x3(base_width, base_width), TemporalBatchNorm(base_width, T),
                               create_mslif(), sparse_weights=True, sparse_neurons=True)
